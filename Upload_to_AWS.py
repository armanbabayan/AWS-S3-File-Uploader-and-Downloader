...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--folder_path",
        type=str,
        help="The folder directory from where files will be uploaded. "
        'If this argument is passed then "file_path" argument should be None.',
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="In case of uploading single file not files from a directory.",
    )
    parser.add_argument(
        "--bucket_folder",
        type=str,
        default=None,
        help="Folder name in the bucket. Also can be specified like this: home/txt",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="txt",
        help="Type of the files to be uploaded from given directory. "
        'Not applicable in case of uploading single file by passing "file_path" argumnent',
    )
    ...
    if args.folder_path:
        ...
        if file_names:
            logger.info(
                f"Start to upload files to AWS: There are {len(file_names)} files to upload!"
            )
        else:
            logger.info(
                f"There is no file in the {args.folder_path} directory. Check the folder path or add files!"
            )
